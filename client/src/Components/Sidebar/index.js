            ...
            <div className={`sidebar ${isOpenFilter===true && 'open'}`}>
                ...
                <div className="filterBox">
                    ...
                    <div className='d-flex pt-2 pb-2 priceRange'>
                        <span>Từ: <strong className='text-dark'>{value[0]}</strong></span>
                        <span className='ml-auto'>Đến: <strong className='text-dark'>{value[1]}</strong></span>
                    </div>
                </div>
                    ...
                    <div className='scroll pl-0'>
                        {
                            // <ul>
                            //     <li>
                            //         <FormControlLabel className='w-100'  onClick={() => filterByRating(5)} control={<Checkbox />} label="Frito Lay" />
                            //     </li>
